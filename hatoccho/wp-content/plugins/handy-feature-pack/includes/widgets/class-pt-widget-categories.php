...
class pt_categories extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__('Handy Categories', 'handy-feature-pack'), // Name
			array('description' => __( "Handy special widget. Display configurable list of categories on your site.", 'handy-feature-pack' ), )
		);
	}
	...
	?>
		...
		<p>
		    ...
		    <label for ="<?php echo $this->get_field_id('cats_count'); ?>"><?php _e('Show count for categories','handy-feature-pack'); ?></label>
		</p>
		<p>
		    ...
		    <label for ="<?php echo $this->get_field_id('show_img'); ?>"><?php _e('Show images for categories','handy-feature-pack'); ?></label>
		</p>
		<p>
		    ...
		    <label for ="<?php echo $this->get_field_id('hierarchical'); ?>"><?php _e('Show hierarchy','handy-feature-pack'); ?></label>
		</p>
		<p>
		    ...
		    <label for ="<?php echo $this->get_field_id('collapsing'); ?>"><?php _e('Collapsing categories','handy-feature-pack'); ?></label>
		    <br /><small><?php _e('works only when "Show hierarchy" checked.', 'handy-feature-pack'); ?></small>
		</p>
		<p>
		    <label for="<?php echo $this->get_field_id('cats_type'); ?>"><?php _e('Categories type:','handy-feature-pack'); ?>
		        <select class='widefat' id="<?php echo esc_attr($this->get_field_id('cats_type')); ?>" name="<?php echo $this->get_field_name('cats_type'); ?>">
		          <option value='category'<?php echo (esc_attr($instance['cats_type']=='category'))?' selected="selected"':''; ?>><?php _e('Post Categories', 'handy-feature-pack'); ?></option>
		          <option value='product_cat'<?php echo (esc_attr($instance['cats_type']=='product_cat'))?' selected="selected"':''; ?>><?php _e('Product Categories', 'handy-feature-pack'); ?></option>
		        </select>
		    </label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('sortby'); ?>"><?php _e('Sort by:','handy-feature-pack'); ?>
		...
		<p>
		    <label for="<?php echo $this->get_field_id('order'); ?>"><?php _e('Order:','handy-feature-pack'); ?>
		        <select class='widefat' id="<?php echo esc_attr($this->get_field_id('order')); ?>" name="<?php echo $this->get_field_name('order'); ?>">
		          <option value='ASC'<?php echo (esc_attr($instance['order']=='ASC'))?' selected="selected"':''; ?>><?php _e('Ascending', 'handy-feature-pack'); ?></option>
		          <option value='DESC'<?php echo (esc_attr($instance['order']=='DESC'))?' selected="selected"':''; ?>><?php _e('Descending', 'handy-feature-pack'); ?></option>
		        </select>
		    </label>
		</p>
		<p>
		    <label for ="<?php echo $this->get_field_id('exclude_cats'); ?>"><?php _e('Exclude Category (ID): ','handy-feature-pack'); ?></label>
		    ...
		    <small><?php _e('category IDs, separated by commas.', 'handy-feature-pack'); ?></small>
		</p>
