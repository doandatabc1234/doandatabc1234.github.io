...
$responsive_class = ' col-xs-6 col-md-3 col-sm-4';
if ( handy_get_option('store_columns')=='3' ) {
		if ( pt_show_layout()!='layout-one-col' ) {
				$responsive_class = " col-xs-6 col-md-4 col-sm-6";
		} else {
				$responsive_class = " col-xs-6 col-md-4 col-sm-3";
		}
} elseif ( handy_get_option('store_columns')=='4' ) {
		if ( pt_show_layout()!='layout-one-col' ) {
				$responsive_class = " col-xs-6 col-md-3 col-sm-6";
		} else {
				$responsive_class = " col-xs-6 col-md-3 col-sm-4";
		}
}
