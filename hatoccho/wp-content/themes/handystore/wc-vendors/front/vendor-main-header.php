...
$logo_src = get_user_meta( $vendor->ID, 'pv_logo_image', true );
$logo_pos = get_user_meta( $vendor->ID, 'pv_logo_position', true );
$featured_carousel = get_user_meta( $vendor->ID, 'pv_featured_carousel', true );
	...
	<?php if ( $featured_carousel == 'on' && $products->have_posts() ) : ?>
		...
		>
			<div class="title-wrapper">
				<h3><?php _e('Special Offers', 'handystore')?></h3>
