	  ...
	  <table class="form-table">
		  ...
		  <tr>
		    ...
		    <td>
				...
				<span id="pv_logo_image_button" class="button pt_upload_image_button"><?php esc_html_e( 'Upload', 'handystore' ); ?></span>
			</td>
		  </tr>
		  ...
		  <tr>
		    ...
		    <?php $value = get_user_meta( $user_id,'pv_logo_position', true );
		    	  if ( $value == '' ) $value = 'left'; ?>
			    <input type="radio" class="input-radio" name="pv_logo_position" id="logo_position_left" value="left" <?php checked( $value, 'left'); ?>/><label for="logo_position_left"><?php esc_html_e( ' Left', 'handystore' ); ?></label><br />
				<input type="radio" class="input-radio" name="pv_logo_position" id="logo_position_center" value="center" <?php checked( $value, 'center'); ?>/><label for="logo_position_center"><?php esc_html_e( ' Center', 'handystore' ); ?></label><br />
				<input type="radio" class="input-radio" name="pv_logo_position" id="logo_position_right" value="right" <?php checked( $value, 'right'); ?>/><label for="logo_position_right"><?php esc_html_e( ' Right', 'handystore' ); ?></label>
			</td>
		  </tr>
...
if (!function_exists('pt_add_frontend_vendor_fields')) {
	function pt_add_frontend_vendor_fields() { ?>
	  ...
	  <div class="pv_featured_carousel_container">
	    ...
	    <?php $value = get_user_meta( $user_id,'pv_featured_carousel', true ); ?>
	    <p>
	    	<input type="checkbox" class="input-checkbox" name="pv_featured_carousel" id="pv_featured_carousel" <?php checked( $value, 'on' ); ?> /><label class="checkbox" for="pv_featured_carousel"><?php esc_html_e( 'Check if you want to add carousel with featured products to your shop page', 'handystore' ) ?></label>
		</p>
	  </div>
		...
		<?php if ( handy_get_option('enable_vendors_product_feedback') == 'on') : ?>
		  <div class="pv_question_form_container">
		    ...
		    <?php $value = get_user_meta( $user_id,'pv_question_form', true ); ?>
		    <p>
		    	<input type="checkbox" class="input-checkbox" name="pv_question_form" id="pv_question_form" <?php checked( $value, 'on' ); ?> /><label class="checkbox" for="pv_question_form"><?php esc_html_e( 'Check if you want to add "Ask a question about this product" form to "Seller Tab" on each of your products', 'handystore' ) ?></label>
			</p>
		  </div>
		<?php endif; ?>
